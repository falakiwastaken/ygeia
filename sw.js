...
const SHELL = [
  ...
  './js/auth.js?v=18',
  './js/domain.js?v=18',
  './js/domain-life.js?v=18',
  './js/domain-cut.js?v=18',
  './js/domain-study.js?v=18',
  './js/domain-rank.js?v=18',
  './js/domain-plan.js?v=18',
  './js/domain-insights.js?v=18',
  './js/domain-timeline.js?v=18',
  './js/domain-gaps.js?v=18',
  './js/data-meals.js?v=18',
  './js/data-programs.js?v=18',
  './js/explain.js?v=18',
  './js/data-foods.js?v=18',
  './js/data-exercises.js?v=18',
  './js/ui.js?v=18',
  './js/charts.js?v=18',
  './js/map.js?v=18',
  './js/openfoodfacts.js?v=18',
  './js/food-parser.js?v=18',
  './js/ai-prompt.js?v=18',
  './js/ai-vision.js?v=18',
  './js/ai-cloud.js?v=18',
  './js/places.js?v=18',
  './js/healthimport.js?v=18',
  './js/backup.js?v=18',
  './js/view-today.js?v=18',
  './js/view-food.js?v=18',
  './js/view-train.js?v=18',
  './js/view-study.js?v=18',
  './js/view-flashcards.js?v=18',
  './js/view-solve.js?v=18',
  './js/view-aikey.js?v=18',
  './js/view-calendar.js?v=18',
  './js/view-coach.js?v=18',
  './js/view-body.js?v=18',
  './js/view-cut.js?v=18',
  './js/view-plan.js?v=18',
  './js/view-lock.js?v=18',
  './js/view-onboard.js?v=18',
  './js/view-settings.js?v=18',
  './js/app.js?v=18',
  './icons/icon.svg',
  './icons/icon-180.png',
];
