...
const SHELL = [
  ...
  './js/auth.js?v=11',
  './js/domain.js?v=11',
  './js/domain-life.js?v=11',
  './js/domain-cut.js?v=11',
  './js/domain-study.js?v=11',
  './js/domain-rank.js?v=11',
  './js/domain-plan.js?v=11',
  './js/domain-insights.js?v=11',
  './js/domain-timeline.js?v=11',
  './js/data-meals.js?v=11',
  './js/data-programs.js?v=11',
  './js/explain.js?v=11',
  './js/data-foods.js?v=11',
  './js/data-exercises.js?v=11',
  './js/ui.js?v=11',
  './js/charts.js?v=11',
  './js/map.js?v=11',
  './js/openfoodfacts.js?v=11',
  './js/food-parser.js?v=11',
  './js/ai-vision.js?v=11',
  './js/ai-local.js?v=11',
  './js/places.js?v=11',
  './js/healthimport.js?v=11',
  './js/view-today.js?v=11',
  './js/view-food.js?v=11',
  './js/view-train.js?v=11',
  './js/view-study.js?v=11',
  './js/view-flashcards.js?v=11',
  './js/view-solve.js?v=11',
  './js/view-calendar.js?v=11',
  './js/view-coach.js?v=11',
  './js/view-body.js?v=11',
  './js/view-cut.js?v=11',
  './js/view-plan.js?v=11',
  './js/view-lock.js?v=11',
  './js/view-settings.js?v=11',
  './js/app.js?v=11',
  './icons/icon.svg',
  './icons/icon-180.png',
];
