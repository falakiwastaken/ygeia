...
const SHELL = [
  ...
  './js/auth.js?v=19',
  './js/domain.js?v=19',
  './js/domain-life.js?v=19',
  './js/domain-cut.js?v=19',
  './js/domain-study.js?v=19',
  './js/domain-rank.js?v=19',
  './js/domain-plan.js?v=19',
  './js/domain-insights.js?v=19',
  './js/domain-timeline.js?v=19',
  './js/domain-gaps.js?v=19',
  './js/data-meals.js?v=19',
  './js/data-programs.js?v=19',
  './js/explain.js?v=19',
  './js/data-foods.js?v=19',
  './js/data-exercises.js?v=19',
  './js/ui.js?v=19',
  './js/charts.js?v=19',
  './js/map.js?v=19',
  './js/openfoodfacts.js?v=19',
  './js/food-parser.js?v=19',
  './js/ai-prompt.js?v=19',
  './js/ai-vision.js?v=19',
  './js/ai-cloud.js?v=19',
  './js/places.js?v=19',
  './js/healthimport.js?v=19',
  './js/backup.js?v=19',
  './js/view-today.js?v=19',
  './js/view-food.js?v=19',
  './js/view-train.js?v=19',
  './js/view-study.js?v=19',
  './js/view-flashcards.js?v=19',
  './js/view-solve.js?v=19',
  './js/view-aikey.js?v=19',
  './js/view-calendar.js?v=19',
  './js/view-coach.js?v=19',
  './js/view-body.js?v=19',
  './js/view-cut.js?v=19',
  './js/view-plan.js?v=19',
  './js/view-lock.js?v=19',
  './js/view-onboard.js?v=19',
  './js/view-settings.js?v=19',
  './js/app.js?v=19',
  './icons/icon.svg',
  './icons/icon-180.png',
];
