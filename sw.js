...
const SHELL = [
  ...
  './js/auth.js?v=8',
  './js/domain.js?v=8',
  './js/domain-life.js?v=8',
  './js/domain-cut.js?v=8',
  './js/domain-study.js?v=8',
  './js/domain-rank.js?v=8',
  './js/domain-plan.js?v=8',
  './js/domain-insights.js?v=8',
  './js/data-meals.js?v=8',
  './js/data-programs.js?v=8',
  './js/explain.js?v=8',
  './js/data-foods.js?v=8',
  './js/data-exercises.js?v=8',
  './js/ui.js?v=8',
  './js/charts.js?v=8',
  './js/map.js?v=8',
  './js/openfoodfacts.js?v=8',
  './js/food-parser.js?v=8',
  './js/places.js?v=8',
  './js/healthimport.js?v=8',
  './js/view-today.js?v=8',
  './js/view-food.js?v=8',
  './js/view-train.js?v=8',
  './js/view-study.js?v=8',
  './js/view-flashcards.js?v=8',
  './js/view-body.js?v=8',
  './js/view-cut.js?v=8',
  './js/view-plan.js?v=8',
  './js/view-lock.js?v=8',
  './js/view-settings.js?v=8',
  './js/app.js?v=8',
  './icons/icon.svg',
  './icons/icon-180.png',
];
