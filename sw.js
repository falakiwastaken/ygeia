...
const SHELL = [
  ...
  './js/auth.js?v=10',
  './js/domain.js?v=10',
  './js/domain-life.js?v=10',
  './js/domain-cut.js?v=10',
  './js/domain-study.js?v=10',
  './js/domain-rank.js?v=10',
  './js/domain-plan.js?v=10',
  './js/domain-insights.js?v=10',
  './js/domain-timeline.js?v=10',
  './js/data-meals.js?v=10',
  './js/data-programs.js?v=10',
  './js/explain.js?v=10',
  './js/data-foods.js?v=10',
  './js/data-exercises.js?v=10',
  './js/ui.js?v=10',
  './js/charts.js?v=10',
  './js/map.js?v=10',
  './js/openfoodfacts.js?v=10',
  './js/food-parser.js?v=10',
  './js/ai-vision.js?v=10',
  './js/ai-local.js?v=10',
  './js/places.js?v=10',
  './js/healthimport.js?v=10',
  './js/view-today.js?v=10',
  './js/view-food.js?v=10',
  './js/view-train.js?v=10',
  './js/view-study.js?v=10',
  './js/view-flashcards.js?v=10',
  './js/view-solve.js?v=10',
  './js/view-calendar.js?v=10',
  './js/view-coach.js?v=10',
  './js/view-body.js?v=10',
  './js/view-cut.js?v=10',
  './js/view-plan.js?v=10',
  './js/view-lock.js?v=10',
