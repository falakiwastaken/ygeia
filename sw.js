...
const SHELL = [
  ...
  './js/auth.js?v=9',
  './js/domain.js?v=9',
  './js/domain-life.js?v=9',
  './js/domain-cut.js?v=9',
  './js/domain-study.js?v=9',
  './js/domain-rank.js?v=9',
  './js/domain-plan.js?v=9',
  './js/domain-insights.js?v=9',
  './js/data-meals.js?v=9',
  './js/data-programs.js?v=9',
  './js/explain.js?v=9',
  './js/data-foods.js?v=9',
  './js/data-exercises.js?v=9',
  './js/ui.js?v=9',
  './js/charts.js?v=9',
  './js/map.js?v=9',
  './js/openfoodfacts.js?v=9',
  './js/food-parser.js?v=9',
  './js/ai-vision.js?v=9',
  './js/places.js?v=9',
  './js/healthimport.js?v=9',
  './js/view-today.js?v=9',
  './js/view-food.js?v=9',
  './js/view-train.js?v=9',
  './js/view-study.js?v=9',
  './js/view-flashcards.js?v=9',
  './js/view-solve.js?v=9',
  './js/view-body.js?v=9',
  './js/view-cut.js?v=9',
  './js/view-plan.js?v=9',
  './js/view-lock.js?v=9',
