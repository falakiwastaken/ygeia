...
const SHELL = [
  ...
  './js/auth.js?v=14',
  './js/domain.js?v=14',
  './js/domain-life.js?v=14',
  './js/domain-cut.js?v=14',
  './js/domain-study.js?v=14',
  './js/domain-rank.js?v=14',
  './js/domain-plan.js?v=14',
  './js/domain-insights.js?v=14',
  './js/domain-timeline.js?v=14',
  './js/data-meals.js?v=14',
  './js/data-programs.js?v=14',
  './js/explain.js?v=14',
  './js/data-foods.js?v=14',
  './js/data-exercises.js?v=14',
  './js/ui.js?v=14',
  './js/charts.js?v=14',
  './js/map.js?v=14',
  './js/openfoodfacts.js?v=14',
  './js/food-parser.js?v=14',
  './js/ai-vision.js?v=14',
  './js/ai-local.js?v=14',
  './js/places.js?v=14',
  './js/healthimport.js?v=14',
  './js/backup.js?v=14',
  './js/view-today.js?v=14',
  './js/view-food.js?v=14',
  './js/view-train.js?v=14',
  './js/view-study.js?v=14',
  './js/view-flashcards.js?v=14',
  './js/view-solve.js?v=14',
  './js/view-calendar.js?v=14',
  './js/view-coach.js?v=14',
  './js/view-body.js?v=14',
  './js/view-cut.js?v=14',
  './js/view-plan.js?v=14',
  './js/view-lock.js?v=14',
  './js/view-onboard.js?v=14',
  './js/view-settings.js?v=14',
  './js/app.js?v=14',
  './icons/icon.svg',
  './icons/icon-180.png',
];
