...
const SHELL = [
  ...
  './js/auth.js?v=17',
  './js/domain.js?v=17',
  './js/domain-life.js?v=17',
  './js/domain-cut.js?v=17',
  './js/domain-study.js?v=17',
  './js/domain-rank.js?v=17',
  './js/domain-plan.js?v=17',
  './js/domain-insights.js?v=17',
  './js/domain-timeline.js?v=17',
  './js/domain-gaps.js?v=17',
  './js/data-meals.js?v=17',
  './js/data-programs.js?v=17',
  './js/explain.js?v=17',
  './js/data-foods.js?v=17',
  './js/data-exercises.js?v=17',
  './js/ui.js?v=17',
  './js/charts.js?v=17',
  './js/map.js?v=17',
  './js/openfoodfacts.js?v=17',
  './js/food-parser.js?v=17',
    './js/ai-prompt.js?v=17',
'./js/ai-vision.js?v=17',
  './js/ai-local.js?v=17',
  './js/ai-cloud.js?v=17',
  './js/places.js?v=17',
  './js/healthimport.js?v=17',
  './js/backup.js?v=17',
  './js/view-today.js?v=17',
  './js/view-food.js?v=17',
  './js/view-train.js?v=17',
  './js/view-study.js?v=17',
  './js/view-flashcards.js?v=17',
  './js/view-solve.js?v=17',
  './js/view-aikey.js?v=17',
  './js/view-calendar.js?v=17',
  './js/view-coach.js?v=17',
  './js/view-body.js?v=17',
  './js/view-cut.js?v=17',
  './js/view-plan.js?v=17',
  './js/view-lock.js?v=17',
  './js/view-onboard.js?v=17',
  './js/view-settings.js?v=17',
  './js/app.js?v=17',
  './icons/icon.svg',
  './icons/icon-180.png',
];
