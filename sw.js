...
const SHELL = [
  ...
  './js/auth.js?v=20',
  './js/domain.js?v=20',
  './js/domain-life.js?v=20',
  './js/domain-cut.js?v=20',
  './js/domain-study.js?v=20',
  './js/domain-rank.js?v=20',
  './js/domain-plan.js?v=20',
  './js/domain-insights.js?v=20',
  './js/domain-timeline.js?v=20',
  './js/domain-gaps.js?v=20',
  './js/data-meals.js?v=20',
  './js/data-programs.js?v=20',
  './js/explain.js?v=20',
  './js/data-foods.js?v=20',
  './js/data-exercises.js?v=20',
  './js/ui.js?v=20',
  './js/charts.js?v=20',
  './js/map.js?v=20',
  './js/openfoodfacts.js?v=20',
  './js/food-parser.js?v=20',
  './js/ai-prompt.js?v=20',
  './js/ai-vision.js?v=20',
  './js/ai-cloud.js?v=20',
  './js/places.js?v=20',
  './js/healthimport.js?v=20',
  './js/backup.js?v=20',
  './js/view-today.js?v=20',
  './js/view-food.js?v=20',
  './js/view-train.js?v=20',
  './js/view-study.js?v=20',
  './js/view-flashcards.js?v=20',
  './js/view-solve.js?v=20',
  './js/view-aikey.js?v=20',
  './js/view-calendar.js?v=20',
  './js/view-coach.js?v=20',
  './js/view-body.js?v=20',
  './js/view-cut.js?v=20',
  './js/view-plan.js?v=20',
  './js/view-lock.js?v=20',
  './js/view-onboard.js?v=20',
  './js/view-settings.js?v=20',
  './js/app.js?v=20',
  './icons/icon.svg',
  './icons/icon-180.png',
];
